...
var authors = "Eaux Tacous#1021Play";
var version = 1;
...
var getPrimaryEquation = () => {
    ...
    const aTheory = game.activeTheory;
    return ((aTheory.upgrades[4].cost.getCost(aTheory.upgrades[4].level) -
      aTheory.upgrades[4].currency.value).abs() / BigNumber.from("1e587")).toString(20, 1);
}
